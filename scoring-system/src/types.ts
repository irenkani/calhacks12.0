...
export interface VisualizationData {
  /** Chart data for consumption over time */
  consumptionChart: ChartDataPoint[];
  /** Chart data for rate over time */
  rateChart: ChartDataPoint[];
  /** Chart data for scores over time */
  scoreChart: ChartDataPoint[];
  /** Pace indicators for each interval */
  paceIndicators: PaceIndicator[];
}

export interface ChartDataPoint {
  /** X-axis value (timestamp or interval index) */
  x: number;
  /** Y-axis value */
  y: number;
  /** Optional label */
